...
parse.add_argument('--input', dest='input', type=str, default='/media/ht/HT-hlf21/ht_rosbag/liubo/_2023-12-03-15-13-08_right_raw.mp4',)
parse.add_argument('--output', dest='output', type=str, default='/home/ht/ht_code/seg/BiSeNet/res2.mp4',)
